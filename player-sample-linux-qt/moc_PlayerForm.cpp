...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlayerForm_t, stringdata) + ofs \
...
const QMetaObject PlayerForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PlayerForm.data,
      qt_meta_data_PlayerForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PlayerForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayerForm.stringdata))
        return static_cast<void*>(const_cast< PlayerForm*>(this));
